...
def main() -> int:
    parser = argparse.ArgumentParser(description="Find embed_dim that gets closest to target parameter count.")
    parser.add_argument("--config", type=Path, default=Path("configs/train_config_example.yaml"))
